...
本次读取的旧源码提交为 `cb53f228246a39ef8fd2ebcf372b60e0f1cffbf6`。以下文件位置与测试名来自该基线；选定旧测试 36/36、新 Core 对应专项在真实 bubblewrap 下 216/216 已分别执行，均无跳过。它们仍不能代替 DSH rc.1 Executor 等价证明。详见 [K6 当前验证](verification/K6.md)。
