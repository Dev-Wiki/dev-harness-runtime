...
- **权威需求**：[设计文档](../../../../dev-harness-runtime-design.md) §19.5、§29、§31、§41、§45 K9；[资料评估](../Readiness.md)。
...
- **未决问题**：Google Plugin 教程及 Portable 1.0.0 已取证；最低宿主版本、项目级 plugin 机制与真实安装行为尚缺；全局独立 Skill 路径为 ~/.gemini/config/skills/。
