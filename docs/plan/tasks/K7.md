...
- **权威需求**：[设计文档](../../../../dev-harness-runtime-design.md) §19.3、§29、§31、§41、§45 K7；[资料评估](../Readiness.md)。
...
- **未决问题**：Native manifest 最小字段已取证；commands / rules 映射、最低编辑器版本与安装 smoke 尚缺，Executor 默认不启用。
