...
| **K6 — DSH Executor 与行为等价迁移** | 🔴 P0 | 🚧 开发中 | [R0](archive/M0/R0.md)、[R1](archive/M0/R1.md)、[K4](archive/M1/K4.md)、[K6-P](archive/M3/K6-P.md) | G5 / G6 / G8：旧 36 项、新 Core 216 项无跳过；原生权限不足，已安装的 Worker guard 拒绝一次 bash 网络调用；受控编辑桥接未建，自动运行关闭，见[证据](../verification/K6.md) | [执行包](tasks/K6.md) |
