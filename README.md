...
项目已建立 TypeScript / Node.js workspace、Adapter / Build Registry 和 CLI 骨架，并完成 [公共 Contracts](docs/CONTRACTS.md#9-k1-可执行协议) 的类型、Schema 与校验。Core 已提供项目发现、Planning 读取与选择、内容快照及漂移 / 授权提交校验 API。`dhr` 当前提供 help / version；任务编排、Run 状态与平台打包尚未实现。
